...
🟢 **يمكنك الإنتقال إلى [المثال التفصيلي](#مثال-تفصيلي-مع-الشرح-النظري-والتطبيق-العملي) لكي تتضح الصورة أكثر ثم تواصل القراءة لاحقا من هنا**.
...
### سجل التغييرات
جميع التغييرات التي تمت تجدها [هنا](https://github.com/O2sa/semantic-release-demo/blob/main/CHANGELOG.md).
